...
public class MaltListItem implements GridListView.GridRow<Property<GristPart>> {

    public static Collection<GridListView.GridRow<Property<GristPart>>> toGridRows(ObservableList<Property<GristPart>> gps, MaltStore maltStore) {
    ...
    public MaltListItem(Property<GristPart> model, MaltStore ms) {
        this.model = model;
        this.ms = ms;
    }
    ...
    private Node amountPart() {
        ...
        spinner.setValue(model.getValue().getAmount().value());
