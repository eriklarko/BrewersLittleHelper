 ...
 * to find which formulas are available when calculating values of FullContext
 *
 * @author eriklark
 */
public class FormulaClasspathScanner {

    public void findAndAddFormulas(FormulaFactory formulaFactory) throws FormulaFinderException {
    ...
    private void addFormula(FormulaFactory formulaFactory, Class<? extends ObservableFormula> formulaClass) throws IllegalAccessException, SecurityException, NoSuchMethodException, InstantiationException, IllegalArgumentException, InvocationTargetException {
