...
public class MashProfile implements BeerXMLRecord {
    ...
    public final Celsius grainTemperature;
    public final List<MashStep> mashSteps;
    public final String notes;
    public final Celsius tunTemperature;
    public final Celsius spargeTemperature;
    ...
    public MashProfile(String name, Celsius grainTemperature, List<MashStep> mashSteps, String notes, Celsius tunTemperature, Celsius spargeTemperature, PH spargePH, Kilograms tunWeight, double tunSpecificHeat, boolean adjustForEquipmentTemperature) {
        this.name = name;
