...
public class DOMWriter implements BeerXMLWriter<BeerXMLRecord> {
    ...
    private Node transform(BeerXMLRecordSet recordSet, Document doc) throws UnknownRecordSetException {
    ...
    private Node transform(BeerXMLRecord record, Document doc) throws UnknownRecordSetException {
